...
void im2col_gpu(const Dtype* data_im, const int channels,
  ...
  hipLaunchKernelGGL(HIP_KERNEL_NAME(im2col_gpu_kernel<Dtype>), CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS, 0, 0, 
...
void col2im_gpu(const Dtype* data_col, const int channels,
  ...
  // NOLINT_NEXT_LINE(whitespace/operators)
  hipLaunchKernelGGL(HIP_KERNEL_NAME(col2im_gpu_kernel<Dtype>), CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS, 0, 0, 
