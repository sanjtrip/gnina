...
void PoolingLayer<Dtype>::Forward_gpu(
  ...
  // printf("Forward_gpuMAX\n");
    ...
    hipLaunchKernelGGL(HIP_KERNEL_NAME(MaxPoolForward<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
  ...
  case PoolingParameter_PoolMethod_AVE:
    // NOLINT_NEXT_LINE(whitespace/operators)
    hipLaunchKernelGGL(HIP_KERNEL_NAME(AvePoolForward<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
        count, bottom_data,  num_, channels_, num_spatial_axes_,
        input_shape_.gpu_data(), output_shape_.gpu_data(),
        kernel_shape_.gpu_data(),
        stride_.gpu_data(), pad_.gpu_data(), top_data);
  ...
  case PoolingParameter_PoolMethod_STOCHASTIC:
    if (this->phase_ == TRAIN) {
      ...
      // NOLINT_NEXT_LINE(whitespace/operators)
      hipLaunchKernelGGL(HIP_KERNEL_NAME(StoPoolForwardTrain<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
        count, bottom_data,  num_, channels_, num_spatial_axes_,
        input_shape_.gpu_data(), output_shape_.gpu_data(),
        kernel_shape_.gpu_data(),
        stride_.gpu_data(),
      ...
      // NOLINT_NEXT_LINE(whitespace/operators)
      hipLaunchKernelGGL(HIP_KERNEL_NAME(StoPoolForwardTest<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
          count, bottom_data,  num_, channels_, num_spatial_axes_,
        input_shape_.gpu_data(), output_shape_.gpu_data(),
        kernel_shape_.gpu_data(),
...
void PoolingLayer<Dtype>::Backward_gpu(
  ...
  case PoolingParameter_PoolMethod_MAX:
    ...
    // NOLINT_NEXT_LINE(whitespace/operators)
    hipLaunchKernelGGL(HIP_KERNEL_NAME(MaxPoolBackward<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
  ...
  case PoolingParameter_PoolMethod_AVE:
    // NOLINT_NEXT_LINE(whitespace/operators)
    hipLaunchKernelGGL(HIP_KERNEL_NAME(AvePoolBackward<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
  ...
  case PoolingParameter_PoolMethod_STOCHASTIC:
    // NOLINT_NEXT_LINE(whitespace/operators)
    hipLaunchKernelGGL(HIP_KERNEL_NAME(StoPoolBackward<Dtype>), CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS, 0, 0, 
